      ...
      <div className="w-full h-screen flex flex-col justify-between px-8 py-12 z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          <div className="flex flex-col mt-16">
            <motion.h5
              className="text-4xl md:text-3xl lg-text-5xl 2xl:text-7xl font-bold"
              variants={headerAnimate}
              initial="hidden"
              animate="visible"
            >
              70 ans d'expertise au service de la construction
              <br />
              Achetez votre ciment ici!!
              <svg
            ...
            >
              <Link to="/products">
                <motion.button
                  className="px-4 py-2 font-bold bg-white border-4 border-primary rounded-full shadow-md"
